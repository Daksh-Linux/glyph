...
- **PDFs** — drop a PDF into a note and it renders inline, images and formatting intact, using the browser's own viewer (no library, no upload to anyone else). S / M / L height, plus full-screen open
- **One "open file" button** — a picture or PDF goes into the note you're in; a text or code file opens in the editor
